  ...
  <div>
    ...
    <b-row>
      ...
      <b-col>
        ...
        <b-button @click.stop="showModal('Cadastrar', null, null, $event.target)" id="btn-cadastrar" variant="primary" style="display: inline-block;">Cadastrar revista</b-button>
    ...
    data () {
      return {
        ...
        modal_form_fields: [
          ...
          { key: 'num_pag', label: 'Numero de paginas', type: 'number' },
        ],
        table_fields: [
          { key: 'titulo', label: 'Titulo', sortable: true },
          { key: 'editora', label: 'Editora', sortable: true },
          { key: 'num_pag', label: 'Numero de paginas', sortable: true },
          { key: 'data', label: 'Data de publicação', sortable: true },
